...
*/}}
{{- define "cwd-ldap.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}

{{- define "cwd-ldap-properties-name" -}}
{{- printf "%s-%s" (include "cwd-ldap.name" .) "properties" -}}
{{- end }}
...
Common labels
*/}}
{{- define "cwd-ldap.labels" -}}
helm.sh/chart: {{ include "cwd-ldap.chart" . }}
{{ include "cwd-ldap.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "cwd-ldap.selectorLabels" -}}
app.kubernetes.io/name: {{ include "cwd-ldap.name" . }}
...
{{- printf "%s-%s" (include "cwd-ldap.name" .)  .Values.cwd.ldap.db.secretName -}}
{{- end -}}
...
- configMapRef:
    name: {{ include "cwd-ldap-properties-name" . }}
{{- end }}
